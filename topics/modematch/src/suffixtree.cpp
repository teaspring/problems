 ...
 * This program asks you for a line of input, then creates the suffix tree corresponding to the given text. 
 * Additional code is provided to validate the resulting tree after creation.
 */
#include "stdio.h"
#include <iostream>
#include <iomanip>
